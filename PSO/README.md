...
本目录是 [Multi-Agent-Swarm](../README.md) 的 PSO 子项目。
这里保留原包名 `multi_agent_pso`、原 conda 环境名和历史实验；从本目录运行
下面的安装和测试命令。与 GA 的比较和新开发见 [GA](../GA/README.md)。
下文早期“仅讨论 PSO”等内容属于本子项目的原始设计背景。
